...
export const metadata = {
  ...
  description: "Discover Solvestic skincare, thoughtfully formulated for Indian skin to target pigmentation, acne, dryness, pores and dullness with effective solutions.",
};
